...
public class ScriptIndustrialCraft implements IScriptLoader {
    ...
    public void loadRecipes() {
        ...
        OreDictHelper.removeOreDict("circuitBasic", getModItem(IndustrialCraft2.ID, "itemPartCircuit", 1));
        OreDictHelper.removeOreDict("circuitAdvanced", getModItem(IndustrialCraft2.ID, "itemPartCircuitAdv", 1));
